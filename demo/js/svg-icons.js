...
org_tamina_html_component_HTMLApplication.get_componentsXTagList = function() {
	if(org_tamina_html_component_HTMLApplication.componentsXTagList == null) org_tamina_html_component_HTMLApplication.componentsXTagList = { };
...
org_tamina_html_component_HTMLApplication.prototype = {
	loadComponents: function() {
		...
		var _g = 0;
		var _g1 = Reflect.fields(org_tamina_html_component_HTMLApplication.get_componentsXTagList());
		while(_g < _g1.length) {
			var tag = _g1[_g];
			++_g;
			var componentClass = Type.resolveClass(Reflect.field(org_tamina_html_component_HTMLApplication.get_componentsXTagList(),tag));
			customElements.define(tag,componentClass);
		}
		var unknownCustomElements = window.document.querySelectorAll(":not(:defined)");
		var _g2 = 0;
		while(_g2 < unknownCustomElements.length) {
			var el = unknownCustomElements[_g2];
			++_g2;
...
svgicons_html_SVGIcon.__registered = (function($this) {
	var $r;
	Reflect.setField(org_tamina_html_component_HTMLApplication.get_componentsXTagList(),"svg-icon".toLowerCase(),"svgicons.html.SVGIcon");
	$r = true;
	return $r;
}(this));
